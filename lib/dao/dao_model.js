...
var _updateGMM = function (tag, gmm_params, label, config, n_mix, covariance_type, description, count) {
...
exports.updateGMM = function (tag, label, model, config, description) {
    var n_mix = model["nMix"],
        ...
        params = model["params"],
        count = model["count"];
    return _updateGMM(tag, params, label, config, n_mix, covariance_type, description, count);
};
